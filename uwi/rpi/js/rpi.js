var needWiringPi = function() {
  var dlg = $('#needWiringPi');
  if (dlg.length == 0 || !dlg.dialog('isOpen')) {
    dlg.remove();
    dlg = $("<div id='needWiringPi' title='Need WiringPi'><p>You have not installed WiringPi yet.</p><p>Please install WiringPi for accessing the GPIOs.</p></div>");
    dlg.dialog({
      autoOpen: true,
      closeOnEscape: false,
      height: 150,
...
var needWiringPiForPi4 = function(curVer) {
  var dlg = $('#needWiringPiForPi4');
  if (dlg.length == 0 || !dlg.dialog('isOpen')) {
    dlg.remove();
    dlg = $("<div id='needWiringPiForPi4' title='Need Higher Version of WiringPi'><p>You currently have WiringPi version " + curVer + 
    " installed.</p><p>You will need version 2.52 or above to support Raspberry Pi 4.</p></div>");
    dlg.dialog({
      autoOpen: true,
      closeOnEscape: false,
      height: 150,
